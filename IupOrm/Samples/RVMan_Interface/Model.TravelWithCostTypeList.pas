...
uses
  ...
  IupOrm.LazyLoad.Generics.ObjectList, Model.Travel.Interfaces,
  IupOrm.Containers.Interfaces, Model.CostTypeWithCostList.Interfaces;
...
type
  ...
  public
    ...
    // Properties
    [ioHasMany('ICostTypeWithCostList', 'TravelID', ioImmediateLoad)]
