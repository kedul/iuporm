...
uses
  ...
  Data.Bind.ObjectScope, IupOrm.LiveBindings.PrototypeBindSource, FMX.ListView,
  FMX.ListBox, FMX.Edit, FMX.DateTimeCtrls, IupOrm.LiveBindings.Interfaces;
...
type
  TMainForm = class(TForm)
    ...
    eTravelDataPartenza: TEdit;
    eTravelDataArrivo: TEdit;
...
begin
  ...
  begin
//    if (TabControl1.ActiveTab = TabItem1) and (TabControl2.ActiveTab = TabItemCostTypeList) then
//    begin
